...
import shj00007.aa.controls.NumberDialog;
import shj00007.aa.controls.NumberDialog.OnNumberDialogListener;
...
//			etAmount.setFocusable(false);
	...
	private void ShowUserSelectDialog(String p_PayoutType)
	{
		...
		_LinearLayout.setBackgroundResource(R.color.blue);
...
//			m_AlertDialog.dismiss();
			...
			if(m_PayoutType.equals(_PayoutTypeArr[0]) || m_PayoutType.equals(_PayoutTypeArr[1]))
			{
				...
				{
					_Main.setBackgroundResource(R.color.blue);
					mItemColor.remove(_Main);
					mUserSelectedList.remove(_ModelUser);
				}
				else {
					_Main.setBackgroundResource(R.color.red);
