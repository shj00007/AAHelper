package shj00007.aa.database.base;

import java.util.ArrayList;

import shj00007.aa.utility.Reflection;
...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase pDataBase) {
		...
		/*
		 * for (int i = 0; i < _ArrayList.size(); i++) { try { SQLiteDataTable
		 * _SQLiteDataTable = (SQLiteDataTable) mReflection.newInstance(
		 * _ArrayList.get(i), new Object[]{mContext}, new
		 * Class[]{Context.class}); _SQLiteDataTable.OnCreate(pDataBase); }
