...
import shj00007.aa.database.sqlitedal.SQLiteDALAccountBook;
...
public class BusinessAccountBook extends BusinessBase {
	...
	public String GetAccountBookNameByAccountId(int p_BookId) {
		String _ConditionString = "And AccountBookID = "
				+ String.valueOf(p_BookId);
		List<ModelAccountBook> _AccountBooks = m_SqLiteDALAccountBook
				.GetAccountBook(_ConditionString);
