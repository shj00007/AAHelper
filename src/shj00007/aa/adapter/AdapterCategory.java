...
public class AdapterCategory extends BaseExpandableListAdapter {
	...
	public Object getChild(int groupPosition, int childPosition) {
		...
		List _List = m_BusinessCategory
				.GetNotHideCategoryListByParentID(_ModelCategory
						.GetCategoryID());
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			...
			_GroupHolder.Name = (TextView) convertView
					.findViewById(R.id.tvCategoryName);
			_GroupHolder.Count = (TextView) convertView
		...
		int _Count = m_BusinessCategory
				.GetNotHideCountByParentID(_ModelCategory.GetCategoryID());
		_GroupHolder.Count.setText(m_Context.getString(
				R.string.TextViewTextChildrenCategory, _Count));
